class VThread implements  Runnable{
    public void run(){
        ...
        for (int i = 0; i < 5; i++) {
            System.out.println(x.getName()+" going to withdraul  current balance is : "+ B.ac.getbalance());
            B.ac.withdraul(10);
            System.out.println("after withdraul current balance is : "+ B.ac.getbalance());
        }}
}
public class B {
    static Account2 ac=new Account2(50,"454646","saving");
    public static void main(String[] args) {
        VThread r=new VThread();
