...
class remove7{
    public static void main(String[] args) {
        ...
        x.add(s4);
        x.add(s5);
        System.out.println("student2 Vector is : "+ x);
...
// student2 Vector is : [khushi-22, madhu-18, riya-15, arvi-10, shresth-5]
// false
