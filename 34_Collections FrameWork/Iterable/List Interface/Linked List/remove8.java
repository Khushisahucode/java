...
class remove8{
    public static void main(String[] args) {
        LinkedList<student3>x=new LinkedList<student3>();
        ...
        x.add(s4);
        x.add(s5);
        System.out.println("student3 LinkedList is : "+ x);
...
// student3 LinkedList is : [khushi-22, madhu-18, riya-15, arvi-10, shresth-5]
// true
