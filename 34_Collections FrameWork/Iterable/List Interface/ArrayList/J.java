class J {
    public static void main(String[] s0) {
      ...
      s1.add(s5);
      s1.add(s6);
      System.out.println("student ArrayList is : " + String.valueOf(s1));
   }
}
// student ArrayList is : [student@279f2327, student@2ff4acd0, s4]tudent@54bedef2, student@5caf905d, student@27716f