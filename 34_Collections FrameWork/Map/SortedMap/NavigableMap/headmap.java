...
public class headmap {
    ...
    System.out.println(x.headMap(u));
    User u2=new User("nitin",10);
    System.out.println(x.headMap(u2));
     User u3=new User("ashvi",10);
    System.out.println(x.headMap(u3));
}
}
//Map is : {vivek-10=GGITS, uday-192=SRIT, om-12=HEC, mohan-32=BIOT, ashvi-34=BGIEM}
// {vivek-10=GGITS, uday-192=SRIT}
// {vivek-10=GGITS, uday-192=SRIT, om-12=HEC}
// {vivek-10=GGITS, uday-192=SRIT, om-12=HEC, mohan-32=BIOT}
